"""Semantic cache using embedding similarity. Legacy module — see services/cache.py for Redis-backed cache."""
import hashlib
import logging
import numpy as np
...
class SemanticCache:
    """Cache LLM responses based on query semantic similarity (in-memory)."""
